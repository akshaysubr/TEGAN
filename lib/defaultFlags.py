...
def defaultFlags():
    ...
    Flags.DEFINE_string('output_dir', '/home/wongml/Codes/TEGAN/output/', 'The output directory of the checkpoint')
    ...
    Flags.DEFINE_string('input_dir_HR', '/afs/ir/users/w/o/wongml/TEGAN/Data/', 'The directory of the high resolution input data')
