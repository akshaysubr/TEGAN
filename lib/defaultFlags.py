...
def defaultFlags():
    ...
    Flags.DEFINE_string('pre_trained_model_type', 'TEResnet', 'The type of pretrained model (TEGAN or TEResnet)')
    ...
    Flags.DEFINE_string('input_dir_HR', '/farmshare/user_data/akshays/TEGAN/Data/train', 'The directory of the high resolution input data')
