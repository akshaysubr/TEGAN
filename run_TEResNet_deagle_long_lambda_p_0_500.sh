...
--output_dir   /home/manlong/IPython_Notebook/TEGAN/long_new_lambda_p_0_500_con_0_9/${TASK}/output${SUFFIX} \
--summary_dir  /home/manlong/IPython_Notebook/TEGAN/long_new_lambda_p_0_500_con_0_9/${TASK}/summary${SUFFIX} \
--log_file     /home/manlong/IPython_Notebook/TEGAN/long_new_lambda_p_0_500_con_0_9/${TASK}/log${SUFFIX}.dat \
